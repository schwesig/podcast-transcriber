...
def main() -> int:
    ...
    parser.add_argument("--backend", default="auto", choices=["auto", "mlx", "faster-whisper"],
                        help="Transcription backend. auto (default) picks mlx on Apple Silicon when mlx-whisper is installed and the model has an mlx variant, otherwise faster-whisper")
